...
const TenantSelector = () => {
    ...
    const handleSelect = async (tenantId) => {
        ...
        // autoLogin: true tells LandingPage to auto-trigger loginRedirect.
        // By reloading INSTEAD of logoutRedirect, we keep the Microsoft session active
        // so the subsequent loginRedirect can perform SSO and finish instantly.
