...
Write-Host "Restoring stable template build..."
...
# 1. Turn OFF Track Changes and Accept All
$doc.TrackRevisions = $false
$doc.Revisions.AcceptAll()

# 2. REMOVE EXACT INCWERT LOGOS AND COVER GRAPHICS
...
Write-Host "Restored build complete!"
